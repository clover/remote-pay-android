...
public class EnterCustomerNameFragment extends DialogFragment {
  ...
  private View view;
  private Button save;
  List<EnterCustomerNameListener> listeners = new ArrayList<EnterCustomerNameListener>(5);
  ...
  public void onContinue() {
    ...
    if(errorMessage.length() > 0){
      ((ExamplePOSActivity)getActivity()).showPopupMessage(null, new String[] {errorMessage}, false);
    }
  }

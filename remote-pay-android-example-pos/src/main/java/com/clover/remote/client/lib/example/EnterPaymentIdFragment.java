...
public class EnterPaymentIdFragment extends DialogFragment {
  ...
  List<EnterPaymentIdFragmentListener> listeners = new ArrayList<EnterPaymentIdFragmentListener>(5);
  ...
  public void onAttach(Activity activity) {
    ...
    try {
      ...
      throw new ClassCastException(activity.toString() + " must implement EnterPaymentIdFragmentListener");
    }
  }
